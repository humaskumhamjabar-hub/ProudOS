...
$backupDisk = env('BACKUP_DISK') ?: (env('APP_ENV') === 'production' ? 'backup_s3' : 'local');
    ...
    'backup' => [
        ...
        'source' => [
            'files' => [
                 ...
                 */
                'include' => [
                    storage_path('app/private/render'),
                    storage_path('app/private/publikasi'),
                    storage_path('app/private/pustaka'),
                ],
